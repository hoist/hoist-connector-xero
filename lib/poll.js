...
XeroPoller.prototype = {
  ...
  handleResults: function (results, endpointName, singularEndpointName) {
    if (!results.Response[endpointName]) {
      ...
      return this.updateSubscription(endpointName);
    }
    ...
    return BBPromise.settle(_.map(results.Response[endpointName][singularEndpointName], this.raiseEvent))
      ...
      .then(function (promises) {
        return this.updateSubscription(endpointName).then(function () {
          return promises;
        });
      }).catch(function (err) {
  ...
  updateSubscription: function (endpointName) {
    return this.subscription.set(endpointName, this.subscription.meta[endpointName]);
  },
