...
// eventEmitter.on('new:Invoice', function (invoice) {
//   console.log('!event emitter listener', invoice);
// });
// eventEmitter.on('done', function () {
//   console.log('poll listener done');
// });

//array of endpoint names/ singular names? maybe in json file
...
function XeroPoller(app, bucket, subscription, bouncerToken, connectorSettings) {
  ...
  this.subscription.eventEmitter.on('done', function () {
    console.log('poll listener done');
  });
}
